...
description: Your combat logs help solve The Ants' undocumented damage formula.
...
- Your ant's type, level, and attack stat (from the stats screen)
...
Submissions are aggregated anonymously and published as analysis results on the [Damage Formula](damage-calculation.html) page. Individual raw responses are never published as-is.
