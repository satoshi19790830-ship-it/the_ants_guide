...
Joining an alliance gives you construction-time assistance, resource aid, an alliance shop, and daily task rewards — it clearly speeds up your nest's development. It's worth joining early.
...
Raiding an unshielded enemy base to steal resources. Scouting the target first is standard practice. At queen level 8, the new-player shield automatically drops, making you a valid raid target from then on. The "Raider" class specializes in plunder — once its dedicated building unlocks, it grants an extra march and +150% troop carrying capacity on raids.
...
Daily tasks rotate every 8 hours (3 cycles/day), with a different theme each day of the week.

| Day | Theme |
|---|---|
| Mon | Building level-up speed |
| Tue | Soldier ant hatching |
| Wed | Bio-remains consumption (evolution research) |
| Thu | Special ant upgrades / skills |
| Fri | Soldier ant hatching / genetics |
| Sat | Mixed tasks |
